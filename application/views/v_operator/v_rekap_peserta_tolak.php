    ...
    <div class="header">
        ...
        <tr>
          ...
          <td>
            <div class="header-text">
              <h2>Rekap Peserta Ditolak<br> PPDB SMK Muhammadiyah Mlati <br>Tahun Ajaran <?=$tahun['tahun_mulai']?>/<?=$tahun['tahun_akhir']?></h2>
      ...
      <table class="table-me" border="0" cellpadding="3">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="8" style="text-align: center; margin-top: 10px; margin-bottom: 10px;">--- Belum Ada Data ---</td>
          </tr>
          <?php
          }
          ?>
